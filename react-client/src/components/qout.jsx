...
>
      <Mypaper>
      <Grid><Typography component="div" style={{ height: '50vh' , width :'200vh', color : '#F9FBE7',  fontStyle: 'italic', fontSize: 30, padding:'40px 30px 0px 30px' }} >
      ...
      <Grid item xs={2}>
      <Grid><Typography component="div" style={{ height: '7vh' , width :'100vh', color : '#F9FBE7',  fontStyle: 'italic', fontSize: 25, padding:'10px 5px 0px 5px' }} >
      ...
      <MailOutlineIcon style={{ color: lightGreen[50], fontSize: 35 }}/><Grid><Typography component="div" style={{ height: '7vh' , width :'100vh', color : '#F9FBE7',  fontStyle: 'italic', fontSize: 25, padding:'10px 5px 0px 5px', margin:'-50px 10px 10px 50px' }} >carsooq@join.com</Typography></Grid>
      <br></br><br></br>
    </Mypaper></Grid>
